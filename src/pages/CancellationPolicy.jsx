    ...
    <div className="min-h-screen pt-28 pb-20 bg-gray-50">
      <div className="container max-w-3xl">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 space-y-6 text-gray-600 leading-relaxed">
          ...
          <p>Please notify us as soon as possible if you need to cancel. Email us at <span className="text-primary font-bold">dorice@africangenerationadventures.com</span> or <span className="text-primary font-bold">jastin@africangenerationadventures.com</span> with your booking reference.</p>
