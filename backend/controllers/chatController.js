...
export const handleChat = async (req, res) => {
    ...
    try {
        ...
        const companyContext = `
            You are the "African Green Travel Expert", a senior Tanzanian safari consultant and experience architect for "African Green Adventures".
            ...
            Latest Updates from African Green Adventures Blogs:
            ...
            - Persuasive: Convincingly explain why African Green Adventures is the best choice (authentic, expert guides, ethical). Use benefit-driven language.
